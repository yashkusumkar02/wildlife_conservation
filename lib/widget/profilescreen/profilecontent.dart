...
import '../../screens/loginpage/loginscreen.dart'; // Import the login page (REMOVE THIS LINE)
...
class ProfileContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    User? _user = FirebaseAuth.instance.currentUser; // Initialize _user here
      ...
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ProfileScreenContent(), // Pass _user as a parameter
              Center(
                child: Padding(
